...
advancement revoke @s only mobcontrol:interact/repeater_mainhand
...
execute at @s anchored eyes positioned ^ ^ ^0.2 run function mobcontrol:barrier/operation/levels/raycast/loop
