...
execute positioned ^ ^ ^ if block ~ ~ ~ repeater align xyz positioned ~0.5 ~0.5 ~0.5 run function mobcontrol:barrier/operation/levels/raycast/hit
...
execute unless score %moco.i moco_dummy matches 60.. positioned ^ ^ ^0.2 run function mobcontrol:barrier/operation/levels/raycast/loop
